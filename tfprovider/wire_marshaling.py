...
from .wire_format import AttributeWireType, ImmutableJsonishWithUnknown, ImmutableMsgPackish
...
class AttributeWireTypeUnmarshaler(ABC, Generic[W]):
  ...
  def unmarshal_msgpack(self, value: ImmutableMsgPackish) -> ImmutableJsonishWithUnknown:
    pass
